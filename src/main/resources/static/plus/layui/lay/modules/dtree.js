...
//			level: "level",			//层级
    ...
    DTree.prototype.renderSelectDom = function() {
        ...
        _this.obj.wrap('<div class="layui-card dtree-select" dtree-id="' + rootId + '" dtree-card="' + _this.selectCardDiv + '"></div>').wrap('<div class="layui-card-body-a"></div>').wrap('<div id="' + _this.selectTreeDiv + '"></div>');
